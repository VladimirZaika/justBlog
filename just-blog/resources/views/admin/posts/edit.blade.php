...
@section('post-content')
    <div class="w-full max-w-4xl mx-auto py-10 px-4 text-gray-100">
        ...
        <form action="{{ route('admin.posts.update', $post->id) }}" method="UPDATE"
            ...
            <div>
                ...
                <textarea name="exerpt"
                        rows="4"
                        class="w-full rounded-xl bg-gray-950 border border-gray-700 px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        placeholder="Short description of the post">{{ old('exerpt', $post->exerpt) }}</textarea>
            ...
            <div>
                ...
                <textarea name="body"
                        rows="10"
                        class="w-full rounded-xl bg-gray-950 border border-gray-700 px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        placeholder="Write full post content here...">{{ old('body', $post->body) }}</textarea>
